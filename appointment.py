...
class Application:
    def __init__(self, master):
        ...
        # location
        self.location = Label(self.left, text="DoctorId", font=('arial 18 bold'), fg='black', bg='lightgreen')
        ...
        self.submit1 = Button(self.left, text="Add Symptoms", width=20, height=2, bg='steelblue', command=self.add_symp)
        self.submit1.place(x=300, y=440)
        ...
        self.box.insert(END, "Your id :  " + str(self.id))
